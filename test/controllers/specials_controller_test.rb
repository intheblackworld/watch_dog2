...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { description: @special.description, price: @special.price, title: @special.title }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { description: @special.description, price: @special.price, title: @special.title }
    assert_redirected_to special_path(assigns(:special))
  end
